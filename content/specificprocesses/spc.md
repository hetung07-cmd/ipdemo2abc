...
*Hình 1. SPC tách nhiễu tự nhiên của quá trình ra khỏi các tín hiệu cần kỹ sư điều tra.*
...
*Hình 2. Ví dụ trực quan về Quy tắc Nelson 1–4. Các vùng dựa trên các dải sigma tính từ đường tâm.*
...
![Bốn biểu đồ con minh họa Quy tắc Nelson 5-8: Rule 5 — 2 trong 3 điểm vượt 2σ cùng phía; Rule 6 — 4 trong 5 điểm vượt 1σ cùng phía; Rule 7 — 15 điểm liên tiếp nằm trong ±1σ (quá ít biến thiên); Rule 8 — 8 điểm liên tiếp nằm ngoài ±1σ, không điểm nào trong Vùng C](spc/fig3-nelson-rules-5-8.png)

*Hình 3. Ví dụ trực quan về Quy tắc Nelson 5–8. Các quy tắc này phát hiện dịch chuyển vừa phải, sự phân tầng (stratification) và hỗn hợp (mixtures).*
...
![Đồ thị "Capability Links Process Spread and Centering to Specifications": một phân bố chuẩn (overall distribution) với đường trung bình bị dịch về phía USL, hai đường LSL/USL (đứt nét), dải ±3σ được tô bóng, và mũi tên chỉ "Specification width = USL − LSL"](spc/fig4-capability-distribution.png)

*Hình 4. Cp/Pp đo độ phân tán so với bề rộng quy cách; Cpk/Ppk còn "phạt" thêm khi quá trình lệch tâm.*
...
*Hình 6. SPC là một hệ thống vòng kín, không chỉ là một biểu đồ trên dashboard.*
...
![Biểu đồ "Semiconductor Example: Film Thickness Mean Shift": độ dày màng trung bình (nm) theo trình tự lô, dao động quanh CL ≈ 100 nm trong giai đoạn đầu, rồi dịch lên trên CL từ lô thứ 18 trở đi (vùng được tô bóng), với chú thích "Rule 2 signal: 9 points above CL"](spc/fig7-film-thickness-example.png)

*Hình 7. Ví dụ tín hiệu: chín điểm nằm trên đường tâm sau một sự kiện bảo trì.*
